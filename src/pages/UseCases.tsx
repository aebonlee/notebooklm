...
const useCaseCategories = [
  ...
  },
  {
    ...
    title: '연구 & 학술',
    cases: [
      { icon: '📚', title: '문헌 검토', desc: '논문 PDF를 업로드하고 핵심 주장, 방법론, 한계점을 자동 ��출합니다. 인용 번호로 원문 확인이 가능합니다.' },
      { icon: '🔬', title: '논문 작성 지원', desc: '��집한 자료를 바탕으로 연구 질문에 대한 답변을 생성하고, 모든 주장에 출처를 붙입니다.' },
...
const realScenarios = [
  ...
  { title: '대학 강의: 컴퓨팅 사고 과목', desc: '100페이지 교재를 업로드 → 매주 퀴즈 20문항 자동 생성 → Audio Overview로 복습 팟��스트 제공.', result: '학생 만족도 4.7/5.0' },
